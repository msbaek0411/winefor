		...
		<section>
			<div class="w-[33%] media768" style="margin-left: auto; margin-right: auto;">
				<div class="pt-[3%]">
					...
					<li> 
						<div>
							<a :href="idlogin.site" style="text-decoration: none;" target="_blank">
					...
					<li> 
						<div>
							<a :href="idlogin.ressite" style="text-decoration: none;"  target="_blank">
								<div class="pt-[7px]" style="color: black;">
									<div class="w-[4%] float-left mr-[16px] mt-[7px] ml-[2px]">
  ...
  <script>
	...
	export default {
		...
		created() {
			...
			Axios
				.get(`/api/Houses/${this.idlogin.id}`)
				.then(res => {this.idlogin = res.data.House[0]})
		}
	};
